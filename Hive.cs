...
namespace BeehiveSimulator
{
    ...
    class Hive
    {
        ...
        private void InitializeLocations()
        {
            ...
            locations.Add("Entrance", new Point(733, 148));
            locations.Add("Nursery", new Point(151, 267));
            locations.Add("HoneyFactory", new Point(294, 155));
            locations.Add("Exit", new Point(315, 352));
        }
